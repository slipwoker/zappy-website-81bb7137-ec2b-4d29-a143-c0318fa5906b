    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Smart Investors משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '81bb7137-ec2b-4d29-a143-c0318fa5906b',
                    name: data.name || '',
                    email: data.email || '',
